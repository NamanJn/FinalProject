...
# reading the video
cap = cv2.VideoCapture("videos/2flies_10fps_10thAug.mp4")
...
tracker = Tracker(frameROI, writeData=True, writeContourVideo=False, fps=fps, num_of_flies=2, tubeNumber = tube_number)
